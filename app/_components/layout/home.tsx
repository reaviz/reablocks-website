      ...
      <div className="relative z-10 flex flex-col gap-4 py-12">
        <div className="relative flex flex-1 flex-col gap-4">
          ...
          <motion.h1
            ...
            className="text-content-primary text-[40px] font-bold leading-[120%] md:text-[90px]"
          >
        ...
        >
          <p className="text-content-secondary text-base md:text-lg">
            Beautifully designed, highly customizable, Open Source React
            components based on Tailwind and Framer Motion.
          </p>
          <div className="flex gap-4">
            <Link href="/docs">
              <button className="bg-primary text-content-primary shadow-button hover:bg-primary-hover min-w-[125px] whitespace-nowrap rounded-md px-4 py-2 font-semibold transition-colors">
                Get Started →
              </button>
            </Link>
          </div>
              ...
              <div className="flex flex-col gap-2 md:flex-row">
                <div className="flex flex-1 flex-col gap-2 p-3">
                  ...
                  <Link
                    ...
                    className="text-secondary w-fit text-xs md:text-base"
                  >
                    Learn more
                  </Link>
                </div>
...
export const App = () => {
  <ThemeProvider theme={theme}>
    <YourComponents />
          ...
          <footer className="text-content-secondary container px-4 py-6 text-base md:px-24">
            <div className="flex items-center justify-between gap-2">
              ...
              <div className="flex gap-4">
                ...
                >
                  <GithubIcon className="hover:text-content-primary h-5 w-5 transition-colors" />
                </Link>
                <Link
                  aria-label="GoodCode's Linkedin profile"
                  href="https://linkedin.com/company/goodcodeus/"
                >
                  <LinkedinIcon className="hover:text-content-primary h-5 w-5 transition-colors" />
                </Link>
                <Link
                  aria-label="GoodCode's Dribbble profile"
                  href="https://dribbble.com/goodcode"
                >
                  <DribbbleIcon className="hover:text-content-primary h-5 w-5 transition-colors" />
                </Link>
              </div>
            </div>
