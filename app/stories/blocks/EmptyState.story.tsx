...
import { Button, Card, Divider, Input } from "reablocks";
...
export const NoResults = () => (
  ...
  >
    <Card className="w-full px-12 py-12 md:px-24">
      ...
      <motion.div
        ...
        animate={{ y: 0, opacity: 1 }}
      >
        <a className="flex cursor-pointer gap-4 py-4 hover:underline">
          <svg
          ...
          <div className="flex flex-1 flex-col gap-1">
            ...
            <div>
              <span className="text-text-secondary inline-block text-base">
...
export const MissingInfo = () => (
  ...
  >
    <Card
      className="w-full px-12 py-12 md:px-24 md:py-28"
