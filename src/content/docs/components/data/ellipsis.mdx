...
<StoryRenderer path="components/Ellipsis.story.tsx" name="Simple" storybookKey="components-data-ellipsis--simple" />
...
<StoryRenderer path="components/Ellipsis.story.tsx" name="Unexpandable" storybookKey="components-data-ellipsis--unexpandable" />

#### Line Clamping
<StoryRenderer path="components/Ellipsis.story.tsx" name="Lines" storybookKey="components-data-ellipsis--lines" />

## API
The `Ellipsis` component offers flexibility through several properties that adjust its behavior and presentation:
<TSDocProps name="Ellipsis" />
