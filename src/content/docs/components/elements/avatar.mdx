...
<StoryRenderer path="components/Avatar.story.tsx" name="Simple" storybookKey="components-elements-avatar--simple" />
...
<StoryRenderer path="components/Avatar.story.tsx" name="RoundedWithImage" storybookKey="components-elements-avatar--rounded-with-image"/>
