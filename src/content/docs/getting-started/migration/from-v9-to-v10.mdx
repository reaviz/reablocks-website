...
If you’d prefer to keep the look and feel from 9.x, don’t worry — you can still use the legacy Reablocks theme:
...
From there, you can merge it with your custom theme as before. Please note: the theme interface has changed for some components, so you may need to adjust your custom theme accordingly.

If you haven’t already, make sure to also include the Reablocks [default tokens](#9x-theme-tokens) in your project.
