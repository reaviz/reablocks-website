...
<Callout type="info" emoji="ℹ️">
  If you want to use `Reablocks` **prebuilt** theme, without customizing it, please import `reablocks` styles in your app entry file (e.g. `main.tsx`, `index.tsx`) and skip the 6th step.
