...
Wrap your application with the `ThemeProvider` component from `reablocks`. You
can follow the steps [here](/docs/theme/getting-started) to get started with the theme provider.
