...
<ToggleCanvas sourceState="shown" of={TextareaStories.Basic} />
...
<ToggleCanvas of={TextareaStories.Sizes} />
### States
...
- **Disabled**
<ToggleCanvas of={TextareaStories.Disabled} />
- **Auto Focus**
<ToggleCanvas of={TextareaStories.AutoFocus} />
- **Error**
<ToggleCanvas of={TextareaStories.Error} />
- **Full Width**
<ToggleCanvas of={TextareaStories.FullWidth} />
...
- **Default value**
<ToggleCanvas of={TextareaStories.DefaultValue} />
- **Placeholder text**
<ToggleCanvas of={TextareaStories.Placeholder} />
