...
<ToggleCanvas of={InputStories.StartEndAdorment} />

#### State Variations
Implement variations for error states and disabled inputs, providing visual feedback and interaction cues.

- **Error**
<ToggleCanvas of={InputStories.Error} />
- **Disabled**
<ToggleCanvas of={InputStories.Disabled} />

### Value Initialization
Set initial values or placeholders to guide user input or display default values:
- **Placeholder**
<ToggleCanvas of={InputStories.Placeholder} />
- **Default value**
<ToggleCanvas of={InputStories.DefaultValue} />
