...
<ToggleCanvas sourceState="shown" of={ToggleStories.Simple} storybook="components-form-toggle--simple" />
...
<ToggleCanvas sourceState="shown" of={ToggleStories.Sizes} storybook="components-form-toggle--sizes" />
...
<ToggleCanvas sourceState="shown" of={ToggleStories.Disabled} storybook="components-form-toggle--disabled" />
