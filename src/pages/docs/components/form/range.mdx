...
<ToggleCanvas sourceState="shown" of={RangeStories.Single} storybook="components-form-range--single" />
...
<ToggleCanvas sourceState="shown" of={RangeStories.Double} storybook="components-form-range--double" />
