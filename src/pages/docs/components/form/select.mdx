...
<ToggleCanvas sourceState="shown" of={SingleSelectStories.Basic} />
- **Custom Label**
<ToggleCanvas of={SingleSelectStories.CustomLabels} />
- **Create value if not available**
<ToggleCanvas of={SingleSelectStories.Createable} />
- **Values with sections**
<ToggleCanvas of={SingleSelectStories.Groups} />
- **State: Error**
<ToggleCanvas of={SingleSelectStories.Error} />
- **State: Full Width**
<ToggleCanvas of={SingleSelectStories.FluidWidth} />

### Advanced Customization
#### Multi-Select
Allows users to select multiple options, ideal for filtering mechanisms or gathering multiple interests/preferences.
<ToggleCanvas sourceState="shown" of={MultiSelectStories.Basic} />
