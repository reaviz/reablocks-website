...
<ToggleCanvas sourceState="shown" of={EllipsisStories.Simple} storybook="components-data-ellipsis--simple" />
...
<ToggleCanvas sourceState="shown" of={EllipsisStories.Unexpandable} storybook="components-data-ellipsis--unexpandable" />
