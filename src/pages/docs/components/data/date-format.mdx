...
<ToggleCanvas sourceState="shown" of={DateFormatStories.Simple} storybook="components-data-dateformat--simple" />
...
<ToggleCanvas sourceState="shown" of={DateFormatStories.Relative} storybook="components-data-dateformat--relative" />
