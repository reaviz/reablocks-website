...
<ToggleCanvas sourceState="shown" of={PluralizeStories.Simple} storybook="components-data-pluralize--simple" />
...
<ToggleCanvas sourceState="shown" of={PluralizeStories.ZeroCount} storybook="components-data-pluralize--zero-count" />
