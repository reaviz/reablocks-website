...
<ToggleCanvas of={DateSizeStories.Simple} />
...
<ToggleCanvas of={DateSizeStories.Empty} />
...
Below is the function arguments for `formatSize`:

<ParametersTable type="functions" name="formatSize" />
