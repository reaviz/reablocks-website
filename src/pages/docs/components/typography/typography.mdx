...
### PageTitle
<ToggleCanvas sourceState="shown" of={PageTitleStories.Simple} storybook="components-typography-pagetitle--simple" />

### PrimaryHeading
<ToggleCanvas sourceState="shown" of={PrimaryHeadingStories.Simple} storybook="components-typography-primaryheading--simple" />

### SecondaryHeading
<ToggleCanvas sourceState="shown" of={SecondaryHeadingStories.Simple} storybook="components-typography-secondaryheading--simple" />

### Text
<ToggleCanvas sourceState="shown" of={TextStories.Simple} storybook="components-typography-text--simple" />

### Sub
<ToggleCanvas sourceState="shown" of={SubStories.Simple} storybook="components-typography-sub--simple" />
