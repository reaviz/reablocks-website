...
<ToggleCanvas sourceState="shown" of={ChipStories.Variants} storybook="components-elements-chip--variants" />
...
<ToggleCanvas of={ChipStories.Colors} />

<ToggleCanvas of={ChipStories.Sizes} />
