...
import { LoginBasic } from '../samples/LoginBasic';
import { LoginPassword } from '../samples/LoginPassword';
import { LoginSocial } from '../samples/LoginSocial';
import { LoginFull } from '../samples/LoginFull';
...
<Tabs>
    ...
    <TabPanel>
      <div className="flex flex-col border justify-center items-center min-h-[780px] border-gray-700 light:bg-white light:text-black">
        <LoginFull />
      </div>
    </TabPanel>
    <TabPanel>
    ...
    >
      ...
      >
        <div className="flex w-full grow flex-col justify-center pr-14">
          <svg
            className="mb-2 h-11 self-start"
            width="260"
            height="341"
            viewBox="0 0 260 341"
            fill="none"
