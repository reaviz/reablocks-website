...
import { ForgotPassword } from '../samples/ForgotPassword';
import { ForgotPasswordFull } from '../samples/ForgotPasswordFull';
import { ForgotPasswordMinimal } from '../samples/ForgotPasswordMinimal';
import { ResetPassword } from '../samples/ResetPassword';
import { ResetPasswordMinimal } from '../samples/ResetPasswordMinimal';
...
<Tabs>
    ...
    <TabPanel>
      <div className="flex flex-col border  min-h-[840px] justify-center items-center border-gray-700 light:bg-white light:text-black">
        <ForgotPasswordFull />
      </div>
    </TabPanel>
    <TabPanel>
```tsx
import { Block, Button, Card, Divider, Input, Stack, bg } from "reablocks";
import { motion } from "framer-motion";
import { useForm, Controller } from "react-hook-form";
