...
import { Register } from '../samples/Register';
import { RegisterV2 } from '../samples/RegisterV2';
import { RegisterFull } from '../samples/RegisterFull';
import { RegisterWithSocial } from '../samples/RegisterWithSocial';
...
<Tabs>
    ...
    <TabPanel>
      <div className="flex flex-col border justify-center items-center border-gray-700 min-h-[840px] light:bg-white light:text-black">
        <Register />
      </div>
    </TabPanel>
    <TabPanel>
...
{/* why's this block throwing an error */}
...
import { Block, Button, Card, cn, Divider, Input, Radio, radioTheme, Select, SelectOption, Stack } from "reablocks";
import { motion } from "framer-motion";
import { useForm, Controller } from "react-hook-form";
