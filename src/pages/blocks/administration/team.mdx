...
import { TeamGeneral } from '../samples/TeamGeneral';
import { TeamMinimal } from '../samples/TeamMinimal';
import { TeamRoles } from '../samples/TeamRoles';
...
import React, { FC, useState } from 'react';
import { motion } from 'framer-motion';
import { Card, Avatar, Button, Divider, IconButton, Checkbox, CheckboxTheme, checkboxTheme as defaultCheckboxTheme, Stack } from 'reablocks';
...
import React, { FC, useState } from 'react';
import { motion } from 'framer-motion';
import { Card, Avatar, Button, Tab, TabList, TabPanel, Tabs, Divider, IconButton, Input, Stack } from 'reablocks';
