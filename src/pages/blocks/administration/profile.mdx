...
import { Profile } from '../samples/Profile';
...
<Tabs>
    ...
    <TabPanel>
```tsx
import { Stack, Input, Button, Avatar, Card, Divider, Radio } from "reablocks";
...
export const Profile = () => (
  <motion.div
    ...
    className="mb-10 mt-10 sm:mx-auto sm:w-full sm:max-w-sm md:max-w-[800px]"
  >
    <Card className="w-full p-12">
      <Stack>
        <svg
          className="mb-2 mr-2 h-11 w-auto"
          width="260"
          height="341"
          viewBox="0 0 260 341"
          fill="none"
        ...
        <div>
          <h2 className="font-sans text-xl font-bold">Reablocks</h2>
          <p className="opacity-60">github.com/reaviz</p>
        </div>
      </Stack>
      <h1 className="mt-5 font-sans text-2xl font-bold">Profile Settings</h1>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <Stack justifyContent="end">
          <div className="flex h-full items-center rounded p-2 ">
            <Avatar className="h-10 w-10" name="Austin M" size="xl" />
          </div>
          <div className="w-full rounded border border-dotted border-blue-500 p-2 text-center text-sm opacity-75">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
