...
export default function Home() {
  return (
    ...
    >
      ...
      >
        <nav
          className="relative flex w-full items-center justify-center px-12 py-6 lg:px-32"
          aria-label="Global"
        >
      ...
      <section className={`container mt-24 flex-1`}>
        <div className="flex items-center gap-4">
          <div className="relative flex flex-1 flex-col gap-4">
            ...
            <h1 className="text-6xl font-bold text-content-primary">
          ...
          <div className="flex flex-1 flex-col gap-4">
            ...
            <div className="flex gap-4">
              <button className="shadow-button min-w-[125px] rounded-md border border-primary bg-transparent px-4 py-2 font-semibold text-content-primary">
                Get Started
              </button>
              <button className="shadow-button min-w-[125px] rounded-md bg-primary px-4 py-2 font-semibold text-content-primary hover:bg-primary-hover">
                Demo
              </button>
            </div>
          </div>
