  ...
  return (
    <html lang="en" dir="ltr" suppressHydrationWarning className="h-full">
      <Head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Inter:ital,opsz,wght@0,14..32,100..900;1,14..32,100..900&family=Lexend:wght@100..900&family=Fira+Code:wght@400;500&display=swap"
          rel="stylesheet"
        />
      </Head>
